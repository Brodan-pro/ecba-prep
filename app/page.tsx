...
<<<<<<< HEAD
    ...
    try {
      ...
      setError(
        msg.includes("email-already-in-use") ? "Email already registered. Try signing in." :
        msg.includes("wrong-password") || msg.includes("invalid-credential") ? "Invalid email or password." :
